  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-input bg-background shadow-soft-sm hover:bg-secondary hover:text-secondary-foreground",
        secondary:
        ...
        hero:
          "bg-primary text-primary-foreground shadow-glow hover:shadow-lg hover:bg-primary/90 font-semibold",
        "hero-outline":
          "border-2 border-primary text-primary bg-transparent hover:bg-primary/5 font-semibold",
        accent:
          "bg-accent text-accent-foreground shadow-glow-accent hover:bg-accent/90",
        success:
